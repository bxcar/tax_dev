...
/**
* -------------------------------------------------
* Ordering for Views listing posts
* -------------------------------------------------
*/
...
/**
* -------------------------------------------------
* Ordering for Views listing taxonomy terms
* -------------------------------------------------
*/
...
add_filter( 'wpv_filter_taxonomy_post_query', 'wpv_taxonomy_query_add_sort_post_query', 30, 4 );

function wpv_taxonomy_query_add_sort_post_query( $items, $tax_query_settings, $view_settings, $view_id ) {
    if ( 
...
/**
* -------------------------------------------------
* Ordering for Views listing users
* -------------------------------------------------
*/
