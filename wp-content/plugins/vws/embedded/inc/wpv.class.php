...
class WP_Views {
	...
	function init() {
		...
		*/
		...
		add_action( 'wpv_action_wpv_delete_transient_termmeta_keys', array( $this, 'delete_transient_termmeta_keys' ) );
	...
	*/
	...
	/**
	* delete_transient_termmeta_keys
	*
