...
<head>
    ...
    <meta name="description" content="<?php the_field('services_page_description') ?>">
    <meta name="keywords" content="<?php the_field('services_page_keywords') ?>">
...
<main>
    ...
    <section class="services-page">
        ...
        <div class="wrap wow fadeInUp" data-wow-duration="1s">
            ...
            foreach ($services as $service) {
                ?>
                <a href="<?=$service['services_page_s_services_single_service_link']?>" class="item">
                    <div class="img-block">
    ...
    <section class="feadback-form flags-form">
        <div class="form-wrap wow fadeInUp" data-wow-duration="1s">
            ...
            <form action="">
                <input type="text" placeholder="<?php the_field('services_page_gc_placeholder1') ?>">
                <input type="email" placeholder="<?php the_field('services_page_gc_placeholder2') ?>">
                <textarea name="" placeholder="<?php the_field('services_page_gc_placeholder3') ?>"></textarea>
                <input type="submit" value="<?php the_field('services_page_gc_button_text') ?>">
            </form>
        </div>
    </section>
    <section class="facilities-services-block wow fadeInUp" data-wow-duration="1s">
        ...
        <div class="wrap">
            ...
            foreach ($services_and_facilities as $service_and_facility) {
                ?>
                <a href="<?=$service_and_facility['services_page_ss_services_single_service_link']?>" class="item">
