...
<head>
    ...
    <meta name="description" content="<?php the_field('search_online_usa_page_description_meta') ?>">
    <meta name="keywords" content="<?php the_field('search_online_usa_page_keywords') ?>">
                        ...
                        <div class="list">
                            <ul>
                                ...
                                foreach ($columns_single['serach_online_world_page_search_column'] as $columns_single_country) {
                                    ?>
                                    <li>
                                        <a href="<?= $columns_single_country['serach_online_world_page_search_column_link'] ?>">
